...
import 'package:book_app_reader/tab_3.dart';
import 'package:book_app_reader/CarryOutScreen.dart';
    ...
    return Material(
      ...
      child: Container(
        ...
        child: Transform(
          ...
          child: Container(
            height: double.infinity,
            child:new SingleChildScrollView(  // wrapped the row to avoid overflow
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('images/user9.jpg'),
                      ),
